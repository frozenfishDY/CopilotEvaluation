...
public class TestJSProcess {
    public static void main(String[] args) throws IOException {
        TotalRecord totalRecord=new TotalRecord();
        TotalRecord.processRecordSet();
        //ACC
        Set<Integer> acc_set= TotalRecord.getJsRecord().getAcc_set();
        ...
        //RE
//        Set<Integer> re_set= TotalRecord.getJsRecord().getRe_set();
...
//        //WA
//        Set<Integer> wa_set=TotalRecord.getJsRecord().getWa_set();
...
//        //TLE
//        Set<Integer> tle_set=TotalRecord.getJsRecord().getTle_set();
...
//        //MLE
//        Set<Integer> mle_set=TotalRecord.getJsRecord().getMle_set();
...
//        //Partially Correct
//        Set<Integer> pa_set=TotalRecord.getJsRecord().getPartially_correct_set();
